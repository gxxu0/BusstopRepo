package busstop.example.cmmn.web;
...
public class BusImgPaginationRenderer extends AbstractPaginationRenderer implements ServletContextAware{
	
	private ServletContext servletContext;
	
	public BusImgPaginationRenderer() {
		// no-op
	}
